    ...
    <div className="relative z-10 rounded-lg bg-amber-50 p-8 shadow-three dark:bg-gray-900 sm:p-11 lg:p-8 xl:p-11">
      ...
      <div>
        <input
          ...
          className="border-amber-300 mb-4 w-full rounded-lg border bg-amber-100 px-6 py-3 text-base text-amber-900 outline-none focus:border-amber-500 dark:border-amber-700 dark:bg-amber-900/30 dark:text-amber-100 dark:shadow-none dark:focus:border-amber-500"
        />
        <input
          type="email"
          name="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-lg bg-gradient-to-r from-amber-500 to-amber-600 px-9 py-4 text-base font-medium text-white shadow-amber-500/20 shadow-submit duration-300 hover:from-amber-600 hover:to-amber-700 hover:shadow-amber-600/30 dark:shadow-none"
        />
        <p className="text-center text-base leading-relaxed text-amber-700 dark:text-amber-300">
        ...
        <span className="absolute left-2 top-7">
          ...
          >
            ...
            <defs>
              ...
              >
                <stop
                  stopColor={theme === "light" ? "#F59E0B" : "#FCD34D"}
                  stopOpacity="0.62"
                />
                <stop
                  offset="1"
